...
1. **소개**  
   ![Slide1](results/portfolio/슬라이드1.PNG)

2. **프로젝트 개요**  
   ![Slide2](results/portfolio/슬라이드2.PNG)

3. **데이터 수집, 전처리 및 EDA**  
   ![Slide3](results/portfolio/슬라이드3.PNG)

4. **모델링 및 변수 해석**  
   ![Slide4](results/portfolio/슬라이드4.PNG)

5. **공간적 구조 분석**  
   ![Slide5](results/portfolio/슬라이드5.PNG)

6. **페르소나 기반 입지 점수 산정**  
   ![Slide6](results/portfolio/슬라이드6.PNG)

7. **입지 추천 Heatmap**  
   ![Slide7](results/portfolio/슬라이드7.PNG)

8. **입지 점수 모델의 한계와 확장 가능성**  
   ![Slide8](results/portfolio/슬라이드8.PNG)

9. **마무리**  
   ![Slide9](results/portfolio/슬라이드9.PNG)
